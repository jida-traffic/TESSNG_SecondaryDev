          ...
          <template slot="top">
            <div class="side-top">
              <AlgoliaSearchBox
                ...
                :options="algolia"/>
              <SearchBox v-else-if="$themeConfig.search !== false && $frontmatter.search !== false" @change="test"/>
            </div>
          </template>
...
export default defineComponent({
  components: { Sidebar, Navbar, Password, PersonalInfo, SubSidebar, AlgoliaSearchBox, SearchBox },
  ...
  setup (props, ctx) {
    ...
    return { algolia, isAlgoliaSearch, isSidebarOpen, test,absoluteEncryption, shouldShowNavbar, shouldShowSidebar, pageClasses, hasKey, hasPageKey, isHasKey, isHasPageKey, toggleSidebar, firstLoad }
  },
