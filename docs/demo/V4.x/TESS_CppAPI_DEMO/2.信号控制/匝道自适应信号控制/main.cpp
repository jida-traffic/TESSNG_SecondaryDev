...
int main(int argc, char *argv[])
{
	...
	if (pWindow)
	{
		gpTessInterface->setConfigProperty("__workspace", appDir.path());
		gpTessInterface->setConfigProperty("__netfilepath", QString("./Map/test1.tess"));
		gpTessInterface->setConfigProperty("__simuafterload", false);
		gpTessInterface->setConfigProperty("__custsimubysteps", false);
