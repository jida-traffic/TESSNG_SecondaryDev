package test002.TESS_JavaAPI_demo.four.EmergencyLaneOpeningControl;



import com.jidatraffic.tessng.*;
import test002.TESS_JavaAPI_demo.four.EmergencyLaneOpeningControl.MyNet;
import test002.TESS_JavaAPI_demo.four.EmergencyLaneOpeningControl.MySimulator;
import test002.TESS_JavaAPI_demo.four.PriorityLaneManagement.TESS_API_EXAMPLE;
...
public class MyPlugin extends TessPlugin {
    ...
    public void initGui() {
        ...
        examleWindow = new TESS_API_EXAMPLE();
