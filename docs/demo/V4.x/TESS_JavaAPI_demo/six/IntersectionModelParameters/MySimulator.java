package test002.TESS_JavaAPI_demo.six.IntersectionModelParameters;
...
// 非机动车跟驰参数
            ...
            nonmotorParam.setAlfa(4); // 设置alpha参数
            nonmotorParam.setBeit(2); // 设置beit参数
            nonmotorParam.setSafeDistance(0.5); // 设置安全距离
            nonmotorParam.setSafeInterval(1.5); // 设置安全时距
