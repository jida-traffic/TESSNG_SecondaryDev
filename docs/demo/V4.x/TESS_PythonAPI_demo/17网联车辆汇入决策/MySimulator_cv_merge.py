    ...
    def afterOneStep(self):
        ...
        for vehi in lAllVehi:
            if vehi.vehicleTypeCode() == 10 and vehi.roadId() == 5 and vehi.vehicleDriving().laneNumber() == 0:
                ...
                print(batchNum, vehi.id(), leftFront.id(), leftRear.id(), leftFrontTHW, leftRearTHW) if leftFront and leftRear else print(batchNum, vehi.id(), None, None, leftFrontTHW, leftRearTHW)
